function cargarBotones() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("button_section2").innerHTML = this.responseText;
    ...
    var buttonSection3Element = document.getElementById("button_section3");
...
function cargarContenido2(abrir) {
    var contenedor = document.getElementById('button_section2');
    var ajax = new XMLHttpRequest();
    ajax.open("get", abrir, true);
    ajax.onreadystatechange = function () {
        if (ajax.readyState == 4) {
...
function mostrarImagen(id, nombre) {

    document.getElementById('contenido').innerHTML = `<img src="${id}" alt="${nombre}">`;


    document.getElementById('button_section3').innerHTML = `Nombre de la imagen: ${nombre}.jpg`;
}
